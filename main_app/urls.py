...
urlpatterns = [
  ...
  path('bills/', views.bills_index, name='bills_index'),    path('bills/create/', views.BillsCreate.as_view(), name='bills_create'),   path('bills/<int:pk>/update/', views.BillsUpdate.as_view(), name='bills_update'),
